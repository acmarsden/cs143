...
class A2I inherits IO{
     ...
     c2i(char : String) : Int {
    {out_string("Called c2i with wtring: ");
     out_string(char);
     out_string("\n\n");
...
(* a2i_aux converts the usigned portion of the string.  As a
   programming example, this method is written iteratively.  *)
     ...
     a2i_aux(s : String) : Int {
	    { out_string("Called a2i_aux qith string: ");
          out_string(s);
          out_string("\n\n");
        (let int : Int <- 0 in	
           {	
...
class Main inherits IO {
   ...
   get_int() : Int {
	 ...
	 (let z : A2I <- new A2I in
	    (let s : String <- prompt() in
	       { out_string("preparing to call a2i\n");
           z.a2i(s); 
           out_string("Called a21\n");
           z.a2i(s);
           }
	    )
         );
   ...
   class_type(var : A) : SELF_TYPE {
    {out_string("Beginning class_type()\n");
    (case var of
    ...
    out_string("Finished class_type() \n");
    }
   };
